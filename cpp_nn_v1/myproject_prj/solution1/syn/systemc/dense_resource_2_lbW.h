...
// ==============================================================
#ifndef __dense_resource_2_lbW_H__
#define __dense_resource_2_lbW_H__
...
struct dense_resource_2_lbW_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_resource_2_lbW_ram) {
...
SC_MODULE(dense_resource_2_lbW) {
...
dense_resource_2_lbW_ram* meminst;


SC_CTOR(dense_resource_2_lbW) {
meminst = new dense_resource_2_lbW_ram("dense_resource_2_lbW_ram");
