...
set rc [catch {
  ...
  add_files -quiet /home/nicolo/cernbox/pynq_nn_axis/dma_test_pynq_stream/dma_test_pynq_v2/dma_test_pynq.runs/synth_1/design_1_wrapper.dcp
...
set rc [catch {
  ...
  create_report "impl_1_place_report_utilization_1" "report_utilization -hierarchical_percentages -file design_1_wrapper_utilization_placed_1.rpt -pb design_1_wrapper_utilization_placed_1.pb"
