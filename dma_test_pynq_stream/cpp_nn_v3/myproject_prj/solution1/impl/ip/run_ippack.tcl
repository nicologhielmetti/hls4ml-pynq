...
set Version     "1.0"
set DisplayName "hls4ml-nn"
set Revision    "2104060201"
set Description "NN"
set Device      "zynq"
set AutoFamily  ""
...
set solution_dir "/home/nicolo/cernbox/pynq_nn_axis/dma_test_pynq_stream/cpp_nn_v3/myproject_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {myproject_axi_mux_164_16_1_1
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 vector_rows W 0x0 "Data signal of vector_rows" {{0 32 vector_rows W 0 "Bit 31 to 0 Data signal of vector_rows"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 172 II x}
