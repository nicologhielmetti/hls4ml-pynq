...
module dense_array_array_ap_fixed_16_6_5_3_0_5u_config11_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    ap_block_state1;
reg   [15:0] tmp_data_0_V_reg_1009;
wire    ap_CS_fsm_state2;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_ready;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_done;
reg   [15:0] tmp_data_1_V_reg_1014;
reg   [15:0] tmp_data_2_V_reg_1019;
reg   [15:0] tmp_data_3_V_reg_1024;
reg   [15:0] tmp_data_4_V_reg_1029;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start;
wire    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_idle;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_return_0;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_return_1;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_return_2;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_return_3;
wire   [15:0] grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_return_4;
reg    grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 3'd1;
#0 grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start_reg = 1'b0;
end

dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((io_acc_block_signal_op85 == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start_reg <= 1'b0;
    end else begin
        if ((~((real_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start_reg <= 1'b1;
        end else if ((grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_ready == 1'b1)) begin
            grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((io_acc_block_signal_op85 == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1_ignore_call73 = ((real_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start = grp_dense_wrapper_ap_fixed_ap_fixed_16_6_5_3_0_config11_s_fu_631_ap_start_reg;
...
assign io_acc_block_signal_op85 = (res_stream_V_data_4_V_full_n & res_stream_V_data_3_V_full_n & res_stream_V_data_2_V_full_n & res_stream_V_data_1_V_full_n & res_stream_V_data_0_V_full_n);

assign res_stream_V_data_0_V_din = tmp_data_0_V_reg_1009;

assign res_stream_V_data_1_V_din = tmp_data_1_V_reg_1014;

assign res_stream_V_data_2_V_din = tmp_data_2_V_reg_1019;

assign res_stream_V_data_3_V_din = tmp_data_3_V_reg_1024;

assign res_stream_V_data_4_V_din = tmp_data_4_V_reg_1029;

assign start_out = real_start;

endmodule //dense_array_array_ap_fixed_16_6_5_3_0_5u_config11_s
