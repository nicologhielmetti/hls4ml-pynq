...
// ==============================================================
#ifndef __myproject_axi_mulg8j__HH__
#define __myproject_axi_mulg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_axi_mulg8j) {
    ...
    SC_CTOR(myproject_axi_mulg8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
