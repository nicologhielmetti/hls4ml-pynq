...
wire   [27:0] tmp_515_fu_3014_p4;
wire   [5:0] empty_fu_3030_p1;
wire   [9:0] tmp_2_fu_3038_p3;
wire   [9:0] empty_34_fu_3046_p2;
wire   [4:0] empty_33_fu_3034_p1;
...
assign empty_33_fu_3034_p1 = in_index_0_i_i146_reg_843[4:0];

assign empty_34_fu_3046_p2 = (tmp_2_fu_3038_p3 | 10'd15);
...
assign icmp_ln160_fu_3052_p2 = ((tmp_2_fu_3038_p3 > empty_34_fu_3046_p2) ? 1'b1 : 1'b0);

assign icmp_ln168_fu_3024_p2 = (($signed(tmp_515_fu_3014_p4) > $signed(28'd0)) ? 1'b1 : 1'b0);
...
assign select_ln160_1_fu_3106_p3 = ((icmp_ln160_fu_3052_p2[0:0] === 1'b1) ? tmp_514_fu_3070_p4 : ap_phi_mux_data_V_load_phi_phi_fu_876_p4);
...
always @ (ap_phi_mux_data_V_load_phi_phi_fu_876_p4) begin
    for (ap_tvar_int_0 = 256 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 255 - 0) begin
            tmp_514_fu_3070_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_514_fu_3070_p4[ap_tvar_int_0] = ap_phi_mux_data_V_load_phi_phi_fu_876_p4[255 - ap_tvar_int_0];
        end
    end
end

assign tmp_515_fu_3014_p4 = {{in_index_fu_3008_p2[31:4]}};

assign tmp_fu_3058_p3 = {{empty_33_fu_3034_p1}, {4'd0}};

assign trunc_ln160_1_fu_3162_p1 = and_ln160_fu_3157_p2[15:0];

assign trunc_ln160_2_fu_3166_p1 = w2_V_q0[6:0];

assign trunc_ln160_fu_3066_p1 = empty_34_fu_3046_p2[8:0];
