...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_latency_emb6_rom (
...
initial begin
    $readmemh("./softmax_latency_emb6_rom.dat", ram0);
    $readmemh("./softmax_latency_emb6_rom.dat", ram1);
    $readmemh("./softmax_latency_emb6_rom.dat", ram2);
end
...
softmax_latency_emb6_rom softmax_latency_emb6_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
