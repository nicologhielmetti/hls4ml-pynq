...
proc create_hier_cell_hier_0 { parentCell nameHier } {
  ...
  set myproject_axi_0 [ create_bd_cell -type ip -vlnv CERN:hls4ml:myproject_axi:1.0 myproject_axi_0 ]
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_AXILiteS] [get_bd_intf_pins myproject_axi_0/s_axi_AXILiteS]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins hier_0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins hier_0/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins hier_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier_0/myproject_axi_0/s_axi_AXILiteS/Reg] -force
