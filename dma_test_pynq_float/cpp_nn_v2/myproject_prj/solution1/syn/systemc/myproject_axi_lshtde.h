...
// ==============================================================
#ifndef __myproject_axi_lshtde__HH__
#define __myproject_axi_lshtde__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_axi_lshtde) {
    ...
    SC_CTOR(myproject_axi_lshtde):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
