...
// ==============================================================
#ifndef __myproject_axi_fpeqcK__HH__
#define __myproject_axi_fpeqcK__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_axi_fpeqcK) {
    ...
    SC_CTOR(myproject_axi_fpeqcK):  ACMP_fpext_U ("ACMP_fpext_U") {
