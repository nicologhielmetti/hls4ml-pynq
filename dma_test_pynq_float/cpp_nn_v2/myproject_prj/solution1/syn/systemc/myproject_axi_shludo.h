...
// ==============================================================
#ifndef __myproject_axi_shludo__HH__
#define __myproject_axi_shludo__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_axi_shludo) {
    ...
    SC_CTOR(myproject_axi_shludo):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
